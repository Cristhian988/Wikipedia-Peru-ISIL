  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <button
        ...
        } hover:bg-blue-50 py-1.5 px-2.5 flex items-center justify-center gap-3 cursor-pointer text-primary font-bold -mr-2 rounded relative`}
      ...
      <div
        className={`${
          languages ? "" : "hidden"
        } flex flex-col bg-white pb-4 absolute top-32 right-[31.5rem] w-[700px] h-[380px] z-100 transition-all duration-300 shadow-lg border border-gray-300`}
      >
